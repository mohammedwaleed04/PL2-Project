...
int i  ;
            for ( i = 1; i <= 5; i++) {
                try {
                    ...
                    ResultSet rs = st.executeQuery(" select Qname,opt1,opt2,opt3,opt4 from question where id ="+id);
//                    if (rs.next()) {
                        Lbl_Question.setText(rs.getString(1));
                        jRadioButton1_2.setText(rs.getString(2));
                        jRadioButton1_3.setText(rs.getString(3));
                        jRadioButton1_4.setText(rs.getString(4));
                        jRadioButton1_5.setText(rs.getString(5));
//                    } else {
